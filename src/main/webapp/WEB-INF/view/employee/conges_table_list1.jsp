      ...
      <div id="content">
        ...
        <!-- Begin Page Content -->
          ...
          <div class="card shadow mb-4">
            ...
            <center>  <h4 class="m-0 font-weight-bold text-primary">Demande de congés </h4><center>
            </div>
             
			<center><h1>Responsable de la direct</h1></center>
           <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="" width="100%" cellspacing="0">
                  ...
                  <tbody>
						<c:forEach var="conges" items="${listConges}">
				
							<tr>
								<td>${conges.firstName}</td>
								<td>${conges.email}</td>
								<td>${conges.nic}</td>
								<td>${conges.designation}</td>
								<td>${conges.birthday}</td>
								<td>${conges.joinedDate}</td>

                  	  		
                  	  		<td><a href="viewConges?id=${conges.id}" class="btn btn-info btn-icon-split">
                  	  		  		
                        			<span class="text">accepter</span>
                        		</a>
                        	</td>  
                        	<td><a href="deleteConges?id=${conges.id}" class="btn btn-danger btn-icon-split">
