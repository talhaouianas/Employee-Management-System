...
public class ContactController {
	...
	@GetMapping("/admin/remplir")
	public String showremplirdemande() {
		
		return "employee/remplir_demande";
	}
	...
	public String submitContact(HttpServletRequest request,
		...
		helper.setFrom("admin@gmail.com", "Admin Contact");// Add you email name
		helper.setTo("talhaouianas1@gmail.com"); // Add you email Admin name
		helper.setSubject(mailSubject);
		helper.setText(mailContent, true);
		
		ClassPathResource resource = new ClassPathResource("/static/images/ems.jpg");
