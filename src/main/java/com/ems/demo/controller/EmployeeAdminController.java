...
import com.ems.demo.service.BranchService;
...
public class EmployeeAdminController {
	...
	@GetMapping("/admin/conges-datatable")
	public String congesDataTable(Model model) {
		model.addAttribute("listConges", congesService.getAllConges());
		return "employee/conges_table_list";
	}
	
	@GetMapping("/admin/list-conges")
	public String listconges(Model model) {
		model.addAttribute("listConges", congesService.getAllConges());
		return "employee/conges_table_list1";
	}
	@GetMapping("/admin/employee-addconge")
	public String congesAdminAdd() {
		return "employee/contact_form2";
	}
